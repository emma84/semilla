CREATE TABLE orders (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,   -- Identificador único del pedido
    user_id BIGINT NOT NULL,                 -- Usuario que realizó el pedido
    ...
    payment_method_id BIGINT,                -- Método de pago asociado al pedido
