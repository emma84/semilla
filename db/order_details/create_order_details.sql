CREATE TABLE order_details (
    ...
    order_id BIGINT NOT NULL,                       -- Es la clave foránea que hace referencia al pedido (tabla orders)
    product_id BIGINT NOT NULL,                     -- Clave foránea que hace referencia al producto (tabla products)
